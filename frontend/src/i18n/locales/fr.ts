export default {
  ...
  homepage: {
    ...
    scenarioSelection: {
      summary: 'concis',
      title: 'Niveau d\'informations souhaité ?',
      verbose: 'complet',
    },
  ...
  projects: {
    archive: {
      seoDescription: 'Sélection de travaux que j\'ai réalisés ces dernières années.',
      seoTitle: 'Projets',
      tagline: 'Travaux sélectionnés',
    },
    collaboration: 'Une collaboration avec :',
